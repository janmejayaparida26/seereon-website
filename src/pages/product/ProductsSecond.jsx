...
const PROJECTS = [
  {
    ...
    buttonColor: "#019e18", // Bright Blue
    darkButton: false
  },
  {
    ...
    buttonColor: "#019e18", // Very Dark Navy
    darkButton: true
  },
  {
            ...
            {PROJECTS.map((project, index) => (
              ...
              >
                ...
                <div className="absolute inset-0 p-8 md:p-12 flex flex-col justify-end">
                  <h3 className="text-white text-[28px] md:text-[32px] font-['Arimo',sans-serif] font-bold leading-tight mb-6 max-w-[90%]">
                    {project.title}
                  </h3>
